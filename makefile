# IF WINDOWS PATH HAS SOME SPACES WILL NOT WORK
# DIRS
ODIR=./dist/obj
LDIR=./lib
IDIR=./header
...
_DEPS= buffer_service.h decoding_service.h encoding_service.h \
	data_repository.h tree_service.h algorithm_controller.h\
	completion_bar_service.h
DEPS=$(patsubst %,$(IDIR)/%,$(_DEPS))
_OBJ= buffer_service.o decoding_service.o encoding_service.o \
	data_repository.o tree_service.o algorithm_controller.o\
